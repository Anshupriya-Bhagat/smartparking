  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="card-title">ParkingSlot DataTable</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="AdminDashboard">Home</a></li>
              <li class="breadcrumb-item active">List of ParkingSlot</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                ...
                <thead>
                 <tr>
                  ...
                  <td><a href="viewparkingslot?parkingSlotId=${m.parkingSlotId }"><i class="fas fa-eye"></i></a>|
                  <a href="deleteparkingslot?parkingSlotId=${m.parkingSlotId }"><i class="fas fa-trash-alt"></i></a>|
