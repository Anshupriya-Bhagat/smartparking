            ...
            <div class="card">
              ...
              <div class="card-body" style="min-height:702.33px">
                <form action="updatevehicle" method="post">
		          <label>RegistrationNum :</label> <input type="text" name="registrationNum" value="${vehicle.registrationNum}" /><br> <br>
		          <label>VehicleType:</label> <input type="text" name="vehicleType" value="${vehicle.vehicleType}" /><br> <br>
