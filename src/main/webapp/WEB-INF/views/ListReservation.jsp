                ...
                <div class="card-body" style="min-height:502.33px">
                 <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <a href="editreservation?reservationId=${m[0] }"><i class="fas fa-edit"></i></a></td>
                  </tr> 
                  </c:forEach>  
                  </tbody>
                  <tfoot>
               ...
               <%--  <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                 <td>${m[7]}</td>
                     ...
                     <td>${m[3]}</td>
                     <td>${m[1]}</td>
                <td><a href="viewreservation?reservationId=${m[0]}"><i class="fas fa-eye"></i></a>| 
                <a href="deletereservation?reservationId=${m[0]}"><i class="fas fa-trash-alt"></i></a>|
                <a href="editreservation?reservationId=${m[0]}"><i class="fas fa-edit"></i></a></td>
               </tr>
           </c:forEach>
                 </tbody>
