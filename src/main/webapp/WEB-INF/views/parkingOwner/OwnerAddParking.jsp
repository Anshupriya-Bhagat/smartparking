            ...
            <div class="row">
              <div class="col-md-6">
               <!-- /.form-group -->
                <div class="form-group">
                  <label>Title</label>
                 <input type="text" name="title" class="form-control select2" style="width: 100%;">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                <label>Address</label>
                <input type="text" name="address" class="form-control select2" style="width: 100%;">
                 ...
                 <div class="form-group">
                  <label>City</label>
                  <select class="form-control select2" id="city" name="cityId" style="width: 100%;" onchange="getLocation()">
                ...
                <!-- /.form-group -->
                 <div class="form-group">
                  ...
                  <select id="Location" class="form-control select2"  name="locationId" style="width: 100%;">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                 ...
                 <input type="text" name="otherInformation" class="form-control select2">
                </div>
                <!-- /.form-group -->
                 <!-- /.form-group -->
                <div class="form-group">
                  <label>Longitude</label>
                 <input type="text" name="longitude" class="form-control select2">
                </div>
                <!-- /.form-group -->
                 <!-- /.form-group -->
                <div class="form-group">
                  <label>Latitude</label>
                 <input type="text" name="latitude" class="form-control select2">
                </div>
                <!-- /.form-group -->
                <!-- /.form-group -->
                <div class="form-group">
                  <label>Parking Type</label>
                  <select class="form-control select2" name="parkingType" style="width: 100%;">
                ...
                <!-- /.form-group -->
                <input type=submit  class="btn btn-primary" value=saveparking>
              </div>
              <!-- /.col -->
            </div>
            <!-- /.row -->
...
function getLocation() {
    ...
    $.get("/getAllLocationBycityId/" + cityId)
        .done(function(data) {
            console.log(data);
            $('#Location').empty().append('<option selected="selected" value="-1">Select Location</option>');
            for (var i = 0; i < data.length; i++) {
                $('#Location').append('<option value="' + data[i].locationId + '">' + data[i].loctionName + '</option>');
            }
        })
        .fail(function() {
