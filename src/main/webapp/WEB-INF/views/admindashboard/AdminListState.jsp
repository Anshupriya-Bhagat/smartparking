        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="adminewcity" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add City</p>
                </a>
              </li>
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                       <c:forEach items="${allstate}" var="m">
                          ...
                          <td>${m.stateID}</td>
                          <td>${m.stateName}</td>	
                          <td> <a href="adminviewstate?stateID=${m.stateID}"><i class="fas fa-eye"></i></a> | 
                          <a href="admindeletestate?stateID=${m.stateID}"><i class="fas fa-trash-alt"></i></a>|
                          <a  href="admineditstate?stateID=${m.stateID}"><i class="fas fa-edit"></i></a> </td>
                         </tr>
		              </c:forEach>
                  </tbody>
