...
<head>
  ...
  <title>Location DataTables</title>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <div class="card-body">
          <form action="adminsavelocation" method="post">
            <div class="row">
              <div class="col-md-6">
                <!-- /.form-group -->
                <div class="form-group">
                <label>Location</label>
                <input type="text" name="loctionName" class="form-control select2">
                  <div class="form-group">
                  <label>city</label>
                  <select class="form-control select2"  name="cityId" style="width: 100%;">
                ...
                <!-- /.form-group -->
                -
                 <input type=submit  class="btn btn-primary" value=adminsavelocation>
              </div>
            </div>
            <!-- /.row -->
